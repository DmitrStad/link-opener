...
func main() {
	...
	defer f.Close() // Гарантирует закрытие файла в конце работы функции

	// Передаем файл в функцию как io.Writer
	lissajous(f)
}
func lissajous(out io.Writer) {
	const (
		cycles  = 2     // Количество полных колебаний x
		res     = 0.001 // Угловое разрешение
		size    = 100   // Канва изображения охватывает [size..+size]
		nframes = 25    // Количество кадров анимации
		delay   = 2     // Задержка между кадрами (единица - 10мс)
	)
